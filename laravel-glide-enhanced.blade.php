...
$url = Img::url('path/to/image.jpg', ['w' => 600 ])
      ...
      <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div class="overflow-hidden rounded-lg bg-white shadow-md" style="display: flex; flex-direction: column;">
          ...
          <div class="flex items-center justify-center p-6" style="flex-grow: 1;">
            <img alt="Resized" class="h-auto max-w-full" src="{{ Img::url('public/mountainlake.jpg', ['w' => 600]) }}">
          </div>
          <div class="bg-gray-50 px-4 py-3" style="margin-top: auto;">
            <p class="text-sm text-gray-600">Image resized to 300px width</p>
            <code class="mt-2 block text-xs text-gray-500">@{{ Img::url('public/mountainlake.jpg', ['w' => 600]) }}</code>
          </div>
        </div>
        ...
        <div class="overflow-hidden rounded-lg bg-white shadow-md" style="display: flex; flex-direction: column;">
          ...
          <div class="flex items-center justify-center p-6" style="flex-grow: 1;">
            <img alt="WebP" class="h-auto max-w-full" src="{{ Img::webpUrl('public/mountainlake.jpg', ['w' => 300]) }}">
          </div>
          <div class="bg-gray-50 px-4 py-3" style="margin-top: auto;">
            <p class="text-sm text-gray-600">Converted to WebP format for optimization</p>
            <code class="mt-2 block text-xs text-gray-500">@{{ Img::webpUrl('public/mountainlake.jpg', ['w' => 300]) }}</code>
          </div>
        </div>
        ...
        <div class="overflow-hidden rounded-lg bg-white shadow-md" style="display: flex; flex-direction: column;">
          ...
          <div class="flex items-center justify-center p-6" style="flex-grow: 1;">
            <img alt="Thumbnail" class="h-auto max-w-full" src="{{ Img::preset('public/mountainlake.jpg', 'thumbnail') }}">
          </div>
          <div class="bg-gray-50 px-4 py-3" style="margin-top: auto;">
            <p class="text-sm text-gray-600">Using the predefined 'thumbnail' preset</p>
            <code class="mt-2 block text-xs text-gray-500">@{{ Img::preset('public/mountainlake.jpg', 'thumbnail') }}</code>
          </div>
        </div>
        ...
        <div class="overflow-hidden rounded-lg bg-white shadow-md" style="display: flex; flex-direction: column;">
          ...
          <div class="flex items-center justify-center p-6" style="flex-grow: 1;">
            <img alt="Greyscale" class="h-auto max-w-full" src="{{ Img::url('public/mountainlake.jpg', ['w' => 600, 'filt' => 'greyscale']) }}">
          </div>
          <div class="bg-gray-50 px-4 py-3" style="margin-top: auto;">
            <p class="text-sm text-gray-600">Image with greyscale filter</p>
            <code class="mt-2 block text-xs text-gray-500">@{{ Img::url('public/mountainlake.jpg', ['w' => 600, 'filt' => 'greyscale']) }}</code>
          </div>
        </div>
        ...
        <div class="overflow-hidden rounded-lg bg-white shadow-md" style="display: flex; flex-direction: column;">
          ...
          <div class="flex items-center justify-center p-6" style="flex-grow: 1;">
            <img alt="Brightness" class="h-auto max-w-full" src="{{ Img::url('public/mountainlake.jpg', ['w' => 600, 'bri' => 50]) }}">
          </div>
          <div class="bg-gray-50 px-4 py-3" style="margin-top: auto;">
            <p class="text-sm text-gray-600">Image with brightness increased by 50 units</p>
            <code class="mt-2 block text-xs text-gray-500">@{{ Img::url('public/mountainlake.jpg', ['w' => 600, 'bri' => 50]) }}</code>
          </div>
        </div>
        ...
        <div class="overflow-hidden rounded-lg bg-white shadow-md" style="display: flex; flex-direction: column;">
          ...
          <div class="flex items-center justify-center p-6" style="flex-grow: 1;">
            <img alt="Medium" class="h-auto max-w-full" src="{{ Img::preset('public/mountainlake.jpg', 'medium') }}">
          </div>
          <div class="bg-gray-50 px-4 py-3" style="margin-top: auto;">
            <p class="text-sm text-gray-600">Preset 'medium': 400px width, WebP, proportional fit</p>
            <code class="mt-2 block text-xs text-gray-500">@{{ Img::preset('public/mountainlake.jpg', 'medium') }}</code>
          </div>
        </div>
        ...
        <div class="overflow-hidden rounded-lg bg-white shadow-md" style="display: flex; flex-direction: column;">
          ...
          <div class="flex items-center justify-center p-6" style="flex-grow: 1;">
            <img alt="Social" class="h-auto max-w-full" src="{{ Img::preset('public/mountainlake.jpg', 'social') }}">
          </div>
          <div class="bg-gray-50 px-4 py-3" style="margin-top: auto;">
            <p class="text-sm text-gray-600">Optimized for sharing on social media (1200x630px)</p>
            <code class="mt-2 block text-xs text-gray-500">@{{ Img::preset('public/mountainlake.jpg', 'social') }}</code>
          </div>
        </div>
        ...
        <div class="overflow-hidden rounded-lg bg-white shadow-md" style="display: flex; flex-direction: column;">
          ...
          <div class="flex items-center justify-center p-6" style="flex-grow: 1;">
            <img alt="Sepia" class="h-auto max-w-full" src="{{ Img::url('public/mountainlake.jpg', ['w' => 600, 'filt' => 'sepia']) }}">
          </div>
          <div class="bg-gray-50 px-4 py-3" style="margin-top: auto;">
            <p class="text-sm text-gray-600">Image with sepia effect</p>
            <code class="mt-2 block text-xs text-gray-500">@{{ Img::url('public/mountainlake.jpg', ['w' => 600, 'filt' => 'sepia']) }}</code>
          </div>
        </div>
        ...
        <div class="overflow-hidden rounded-lg bg-white shadow-md" style="display: flex; flex-direction: column;">
          ...
          <div class="flex items-center justify-center p-6" style="flex-grow: 1;">
            <img alt="Contrast" class="h-auto max-w-full" src="{{ Img::url('public/mountainlake.jpg', ['w' => 600, 'con' => 30]) }}">
          </div>
          <div class="bg-gray-50 px-4 py-3" style="margin-top: auto;">
            <p class="text-sm text-gray-600">Image with increased contrast</p>
            <code class="mt-2 block text-xs text-gray-500">@{{ Img::url('public/mountainlake.jpg', ['w' => 600, 'con' => 30]) }}</code>
          </div>
        </div>
        ...
        {{-- <div class="overflow-hidden rounded-lg bg-white shadow-md" style="display: flex; flex-direction: column;">
          ...
          <div class="flex items-center justify-center p-6" style="flex-grow: 1;">
            <img alt="Rotated" class="h-auto max-w-full" src="{{ Img::url('public/mountainlake.jpg', ['w' => 600]) }}">
          ...
          <div class="bg-gray-50 px-4 py-3" style="margin-top: auto;">
            ...
            <code class="mt-2 block text-xs text-gray-500">@{{ Img::url('public/mountainlake.jpg', ['w' => 600, 'rot' => 90]) }}</code>
          </div>
        </div> --}}
        ...
        <div class="overflow-hidden rounded-lg bg-white shadow-md" style="display: flex; flex-direction: column;">
          ...
          <div class="flex items-center justify-center p-6" style="flex-grow: 1;">
            <img alt="Cropped" class="h-auto max-w-full" src="{{ Img::url('public/mountainlake.jpg', ['w' => 600, 'h' => 600, 'fit' => 'crop']) }}">
          </div>
          <div class="bg-gray-50 px-4 py-3" style="margin-top: auto;">
            <p class="text-sm text-gray-600">Square 600x600 centered crop</p>
            <code class="mt-2 block text-xs text-gray-500">@{{ Img::url('public/mountainlake.jpg', ['w' => 600, 'h' => 600, 'fit' => 'crop']) }}</code>
          </div>
        </div>
        ...
        <div class="overflow-hidden rounded-lg bg-white shadow-md" style="display: flex; flex-direction: column;">
          ...
          <div class="flex items-center justify-center p-6" style="flex-grow: 1;">
            <img alt="With watermark" class="h-auto max-w-full" src="{{ Img::url('public/mountainlake.jpg', ['w' => 600, 'mark' => 'watermarks/logo.png', 'markw' => 100, 'markpos' => 'bottom-left', 'markalpha' => 60]) }}">
          </div>
          <div class="bg-gray-50 px-4 py-3" style="margin-top: auto;">
            <p class="text-sm text-gray-600">Image with semi-transparent watermark</p>
            <code class="mt-2 block text-xs text-gray-500">@{{ Img::url('public/mountainlake.jpg', ['w' => 600, 'mark' => 'watermarks/logo.png', 'markw' => 100, 'markpos' => 'bottom-left', 'markalpha' => 60]) }}</code>
          </div>
        </div>
        ...
        <div class="overflow-hidden rounded-lg bg-white shadow-md" style="display: flex; flex-direction: column;">
          ...
          <div class="flex items-center justify-center p-6" style="flex-grow: 1;">
            <img alt="Multiple effects" class="h-auto max-w-full" src="{{ Img::url('public/mountainlake.jpg', ['w' => 600, 'filt' => 'greyscale', 'blur' => 5, 'bri' => 10]) }}">
          </div>
          <div class="bg-gray-50 px-4 py-3" style="margin-top: auto;">
            <p class="text-sm text-gray-600">Greyscale + blur + brightness</p>
            <code class="mt-2 block text-xs text-gray-500">@{{ Img::url('public/mountainlake.jpg', ['w' => 600, 'filt' => 'greyscale', 'blur' => 5, 'bri' => 10]) }}</code>
          </div>
        </div>
      </div>
      ...
      <div class="mt-12 rounded-lg bg-white p-6 shadow-md">
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2" style="display: grid; grid-auto-rows: 1fr;">
          ...
          <div class="overflow-hidden rounded-lg bg-white shadow-md" style="display: flex; flex-direction: column;">
            ...
            <div class="flex items-center justify-center p-6" style="flex-grow: 1;">
              <img alt="Responsive with pixel density" src="{{ Img::url('public/mountainlake.jpg', ['w' => 600]) }}" srcset="{{ Img::url('public/mountainlake.jpg', ['w' => 600]) }} 1x, {{ Img::url('public/mountainlake.jpg', ['w' => 1200]) }} 2x, {{ Img::url('public/mountainlake.jpg', ['w' => 1800]) }} 3x">
            </div>
            <div class="bg-gray-50 px-4 py-3" style="margin-top: auto;">
              <p class="text-sm text-gray-600">Image with pixel density variants (1x, 2x, 3x)</p>
              <code class="mt-2 block text-xs text-gray-500">src="@{{ Img::url('public/mountainlake.jpg', ['w' => 600]) }}" srcset="@{{ Img::url('public/mountainlake.jpg', ['w' => 600]) }} 1x, @{{ Img::url('public/mountainlake.jpg', ['w' => 1200]) }} 2x, @{{ Img::url('public/mountainlake.jpg', ['w' => 1800]) }} 3x"</code>
            </div>
          </div>
          ...
          <div class="overflow-hidden rounded-lg bg-white shadow-md" style="display: flex; flex-direction: column;">
            ...
            <div class="flex items-center justify-center p-6" style="flex-grow: 1;">
              <img alt="Auto-generated srcset" src="{{ Img::url('public/mountainlake.jpg', ['w' => 600, 'fm' => 'webp']) }}" srcset="{{ Img::srcset('public/mountainlake.jpg', ['w' => 600, 'fm' => 'webp']) }}">
            </div>
            <div class="bg-gray-50 px-4 py-3" style="margin-top: auto;">
              <p class="text-sm text-gray-600">Auto-generated srcset with the new srcset method</p>
              <code class="mt-2 block text-xs text-gray-500">srcset="@{{ Img::srcset('public/mountainlake.jpg', ['w' => 600, 'fm' => 'webp']) }}"</code>
            </div>
          </div>
          ...
          <div class="overflow-hidden rounded-lg bg-white shadow-md" style="display: flex; flex-direction: column;">
            ...
            <div class="flex items-center justify-center p-6" style="flex-grow: 1;">
              <picture>
                <source media="(min-width: 1920px)" srcset="{{ Img::webpUrl('public/mountainlake.jpg', ['w' => 1600]) }} 1x, {{ Img::webpUrl('public/mountainlake.jpg', ['w' => 3200]) }} 2x">
                <source media="(min-width: 1024px)" srcset="{{ Img::webpUrl('public/mountainlake.jpg', ['w' => 1200]) }} 1x, {{ Img::webpUrl('public/mountainlake.jpg', ['w' => 2400]) }} 2x">
                <source media="(min-width: 768px)" srcset="{{ Img::webpUrl('public/mountainlake.jpg', ['w' => 800]) }} 1x, {{ Img::webpUrl('public/mountainlake.jpg', ['w' => 1600]) }} 2x">
                <source media="(min-width: 640px)" srcset="{{ Img::webpUrl('public/mountainlake.jpg', ['w' => 600]) }} 1x, {{ Img::webpUrl('public/mountainlake.jpg', ['w' => 1200]) }} 2x">
                <img alt="Responsive image" class="h-auto max-w-full" src="{{ Img::webpUrl('public/mountainlake.jpg', ['w' => 400]) }}" style="max-width: 1200px;">
              </picture>
            </div>
            <div class="bg-gray-50 px-4 py-3" style="margin-top: auto;">
              ...
              <code class="mt-2 block text-xs text-gray-500">
                &lt;picture&gt;<br />
                &lt;source media="(min-width: 1920px)" srcset="@{{ Img::webpUrl('public/mountainlake.jpg', ['w' => 1600]) }} 1x, @{{ Img::webpUrl('public/mountainlake.jpg', ['w' => 3200]) }} 2x"&gt;<br />
                &lt;source media="(min-width: 1024px)" srcset="@{{ Img::webpUrl('public/mountainlake.jpg', ['w' => 1200]) }} 1x, @{{ Img::webpUrl('public/mountainlake.jpg', ['w' => 2400]) }} 2x"&gt;<br />
                &lt;source media="(min-width: 768px)" srcset="@{{ Img::webpUrl('public/mountainlake.jpg', ['w' => 800]) }} 1x, @{{ Img::webpUrl('public/mountainlake.jpg', ['w' => 1600]) }} 2x"&gt;<br />
                &lt;source media="(min-width: 640px)" srcset="@{{ Img::webpUrl('public/mountainlake.jpg', ['w' => 600]) }} 1x, @{{ Img::webpUrl('public/mountainlake.jpg', ['w' => 1200]) }} 2x"&gt;<br />
                &lt;img src="@{{ Img::webpUrl('public/mountainlake.jpg', ['w' => 400]) }}" alt="Responsive image" style="max-width: 1200px;"&gt;<br />
                &lt;/picture&gt;
              </code>
            </div>
          </div>
          ...
          <div class="overflow-hidden rounded-lg bg-white shadow-md" style="display: flex; flex-direction: column;">
            ...
            <div class="flex items-center justify-center p-6" style="flex-grow: 1;">
              <img alt="Image with variable pixel density" class="h-auto max-w-full" src="{{ Img::url('public/mountainlake.jpg', ['w' => 600]) }}" srcset="{{ Img::url('public/mountainlake.jpg', ['w' => 600]) }} 1x, 
                       {{ Img::url('public/mountainlake.jpg', ['w' => 1200]) }} 2x, 
                       {{ Img::url('public/mountainlake.jpg', ['w' => 1800]) }} 3x">
            </div>
            <div class="bg-gray-50 px-4 py-3" style="margin-top: auto;">
              <p class="text-sm text-gray-600">The appropriate version will be displayed based on the device's pixel density</p>
              <code class="mt-2 block text-xs text-gray-500">
                &lt;img srcset="@{{ Img::url('public/mountainlake.jpg', ['w' => 600]) }} 1x, 
                       @{{ Img::url('public/mountainlake.jpg', ['w' => 1200]) }} 2x, 
                       @{{ Img::url('public/mountainlake.jpg', ['w' => 1800]) }} 3x"
                src="@{{ Img::url('public/mountainlake.jpg', ['w' => 600]) }}"
          ...
          <div class="overflow-hidden rounded-lg bg-white shadow-md" style="display: flex; flex-direction: column;">
            ...
            <div class="flex items-center justify-center p-6" style="flex-grow: 1;">
              <img alt="WebP with different densities" class="h-auto max-w-full" src="{{ Img::url('public/mountainlake.jpg', ['w' => 600, 'fm' => 'jpg']) }}" srcset="{{ Img::url('public/mountainlake.jpg', ['w' => 600, 'fm' => 'webp']) }} 1x, 
                       {{ Img::url('public/mountainlake.jpg', ['w' => 1200, 'fm' => 'webp']) }} 2x, 
                       {{ Img::url('public/mountainlake.jpg', ['w' => 1800, 'fm' => 'webp']) }} 3x">
            </div>
            <div class="bg-gray-50 px-4 py-3" style="margin-top: auto;">
              <p class="text-sm text-gray-600">Optimized WebP format with different resolutions based on device</p>
              <code class="mt-2 block text-xs text-gray-500">
                &lt;img srcset="@{{ Img::url('public/mountainlake.jpg', ['w' => 600, 'fm' => 'webp']) }} 1x, 
                       @{{ Img::url('public/mountainlake.jpg', ['w' => 1200, 'fm' => 'webp']) }} 2x, 
                       @{{ Img::url('public/mountainlake.jpg', ['w' => 1800, 'fm' => 'webp']) }} 3x"
                src="@{{ Img::url('public/mountainlake.jpg', ['w' => 600, 'fm' => 'jpg']) }}"
          ...
          <div class="overflow-hidden rounded-lg bg-white shadow-md" style="display: flex; flex-direction: column;">
            ...
            <div class="flex items-center justify-center p-6" style="flex-grow: 1;">
              <img alt="Optimized with DPR" class="h-auto max-w-full" src="{{ Img::url('public/mountainlake.jpg', ['w' => 800, 'dpr' => 2, 'fm' => 'webp', 'q' => 85]) }}" style="max-width: 800px;">
            </div>
            <div class="bg-gray-50 px-4 py-3" style="margin-top: auto;">
              <p class="text-sm text-gray-600">Image optimized using DPR=2 for retina/4K screens (generates a 1600px wide image)</p>
              <code class="mt-2 block text-xs text-gray-500">
                &lt;img src="@{{ Img::url('public/mountainlake.jpg', ['w' => 800, 'dpr' => 2, 'fm' => 'webp', 'q' => 85]) }}"
...
// Later in your code:
$product->getImageUrl('main', '600', 'webp');
